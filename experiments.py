...
# todo I'm thinking about how to provide these models
class pretrain_models():
    ...
    class chairs_model():
        def __init__(self):
            ...
            self.ph_sm_bdw_1 = pretrain_models.abs_mp(path='./pretrain_models/chairs/...',  # todo
                                                      info='flyingchairs(EPE=3.30 )',  # todo
...
def flying_chairs_experiment():
    ...
    # the first stage: decrease the learning rate and finetune, only photo loss and smooth loss, augmentation is used, EPE=3.30 now training maybe lower
    elif stage == 1.1:
        param = {
            'if_show_training': False,
    ...
    # the second stage: bidirection flow and add occlusion checking(forward-backward check, range map check is not implemented) todo
    elif stage == 2:
